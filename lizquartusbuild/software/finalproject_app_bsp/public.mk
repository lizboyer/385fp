...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../finalprojectqsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is finalprojectqsys
SOPC_NAME := finalprojectqsys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80091d0
SOPC_SYSID_FLAG += --sidp=0x80091d0
ELF_PATCH_FLAG  += --sidp 0x80091d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1681282653
SOPC_SYSID_FLAG += --timestamp=1681282653
ELF_PATCH_FLAG  += --timestamp 1681282653
